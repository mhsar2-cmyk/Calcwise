...
const BLOG_CONTENT = {
    1: {
        title: { en: 'Top 10 Phrasal Verbs for Business English', ar: 'أهم 10 أفعال مركبة للأعمال' },
        content: { 
            en: '<p>Phrasal verbs are essential for natural English in a professional setting. Let\'s explore the top 10 phrasal verbs you need to know:</p><ul style="margin:10px 0 20px 20px;display:flex;flex-direction:column;gap:5px;"><li><strong>Bring up</strong> (to mention a topic)</li><li><strong>Call off</strong> (to cancel an event/meeting)</li><li><strong>Put off</strong> (to postpone)</li><li><strong>Look into</strong> (to investigate)</li><li><strong>Draw up</strong> (to prepare a document/contract)</li><li><strong>Catch up</strong> (to get up to date)</li><li><strong>Take over</strong> (to assume control)</li><li><strong>Step down</strong> (to resign from a position)</li><li><strong>Sort out</strong> (to resolve a problem)</li><li><strong>Set up</strong> (to arrange or organize)</li></ul><p>Using these natively can instantly make you sound more fluent and professional among your peers.</p>',
            ar: '<p>الأفعال المركبة ضرورية للغة إنجليزية طبيعية في بيئة العمل. دعونا نستكشف أهم 10 أفعال مركبة تحتاج إلى معرفتها:</p><ul style="margin:10px 20px 20px 0;display:flex;flex-direction:column;gap:5px;"><li><strong>Bring up</strong> (طرح موضوع)</li><li><strong>Call off</strong> (إلغاء حدث/اجتماع)</li><li><strong>Put off</strong> (تأجيل)</li><li><strong>Look into</strong> (التحقيق في أمر)</li><li><strong>Draw up</strong> (إعداد وثيقة/عقد)</li><li><strong>Catch up</strong> (مواكبة المستجدات)</li><li><strong>Take over</strong> (تولي السيطرة)</li><li><strong>Step down</strong> (التنحي عن منصب)</li><li><strong>Sort out</strong> (حل مشكلة)</li><li><strong>Set up</strong> (ترتيب أو تنظيم)</li></ul><p>استخدام هذه الأفعال بشكل طبيعي يمكن أن يجعلك تبدو أكثر طلاقة واحترافية بين زملائك.</p>'
        }
    },
    2: {
        title: { en: 'How to Prepare for the IELTS Speaking Test', ar: 'كيفية التحضير لاختبار التحدث في الايلتس' },
        content: { 
            en: '<p>To achieve a Band 7+ in the IELTS speaking test, you need an organized strategy. Here are expert tips to follow:</p><h3 style="margin-top:20px;">1. Expand Your Lexical Resource</h3><p>Avoid common words like "good" or "bad". Use "exceptional", "remarkable", or "detrimental". The broader your vocabulary, the higher your score will be.</p><h3 style="margin-top:20px;">2. Master Grammatical Range</h3><p>Ensure you mix your tenses effectively and practice complex sentence structures such as conditionals and relative clauses.</p><h3 style="margin-top:20px;">3. Speak Naturally and Fluently</h3><p>Don’t memorize complete answers; instead, focus on structuring your thoughts clearly. Use cohesive devices like "furthermore," "nevertheless," and "in contrast".</p>',
            ar: '<p>للحصول على درجة 7 أو أعلى في اختبار التحدث في الايلتس، تحتاج إلى استراتيجية منظمة. إليك نصائح الخبراء:</p><h3 style="margin-top:20px;">1. توسيع مواردك المعجمية</h3><p>تجنب الكلمات الشائعة مثل "good" أو "bad". استخدم "exceptional" أو "remarkable" أو "detrimental". فكلما كانت مفرداتك أوسع، زادت درجاتك.</p><h3 style="margin-top:20px;">2. إتقان النطاق النحوي</h3><p>تأكد من مزج الأزمنة بشكل فعال ومارس التراكيب الجملية المعقدة مثل الجمل الشرطية وجمل الوصل.</p><h3 style="margin-top:20px;">3. تحدث بشكل طبيعي وبطلاقة</h3><p>لا تحفظ إجابات كاملة؛ بدلاً من ذلك، ركز على هيكلة أفكارك بوضوح. استخدم أدوات الربط مثل "furthermore" (علاوة على ذلك)، "nevertheless" (ومع ذلك)، و"in contrast" (في المقابل).</p>'
        }
    },
    3: {
        title: { en: 'The Secret to Mastering English Pronunciation', ar: 'سر إتقان النطق في اللغة الإنجليزية' },
        content: {
            en: '<p>Pronunciation goes beyond just saying individual words correctly. It’s about the rhythm, stress, and flow of English.</p><h3 style="margin-top:20px;">Word Stress</h3><p>In English, specific syllables in words are emphasized louder than others. For example, in the word <strong>"photograph"</strong>, the stress is on the first syllable, but in <strong>"photography"</strong>, the stress shifts to the second syllable.</p><h3 style="margin-top:20px;">Sentence Intonation</h3><p>Notice how your pitch rises at the end of a question and falls at the end of a statement. Mimicking native intonations will make you sound much more confident.</p><h3 style="margin-top:20px;">Connected Speech</h3><p>Native speakers link words together. Instead of saying "I want to go," they often say "I wanna go." Practicing these links will drastically improve your listening and speaking skills.</p>',
            ar: '<p>النطق يتجاوز مجرد قول الكلمات الفردية بشكل صحيح. إنه يتعلق بإيقاع اللغة الإنجليزية، والتشديد، والانسيابية.</p><h3 style="margin-top:20px;">التشديد في الكلمات (Word Stress)</h3><p>في اللغة الإنجليزية، يتم التركيز على مقاطع محددة بصوت أعلى من غيرها. على سبيل المثال، في كلمة <strong>"photograph"</strong>، التشديد يكون على المقطع الأول، بينما في كلمة <strong>"photography"</strong>، ينتقل التشديد إلى المقطع الثاني.</p><h3 style="margin-top:20px;">تنغيم الجملة (Sentence Intonation)</h3><p>لاحظ كيف ترتفع نبرة صوتك في نهاية السؤال وتنخفض في نهاية العبارة. محاكاة التنغيم الأصلي ستجعلك تبدو أكثر ثقة بكثير.</p><h3 style="margin-top:20px;">الكلام المتصل (Connected Speech)</h3><p>يقوم المتحدثون الأصليون بربط الكلمات معاً. بدلاً من قول "I want to go"، غالباً ما يقولون "I wanna go". ممارسة هذه الروابط ستحسن بشكل كبير من مهاراتك في الاستماع والتحدث.</p>'
        }
    },
    8: {
        title: { en: 'Overcoming the Fear of Speaking English', ar: 'التغلب على الخوف من التحدث باللغة الإنجليزية' },
        content: {
            en: '<p>It’s completely normal to feel anxious when speaking a new language. Here are practical psychological strategies to help you gain confidence:</p><h3 style="margin-top:20px;">Accept Making Mistakes</h3><p>Mistakes are proof that you are trying. Every error is a learning opportunity. Even native speakers make grammar mistakes when talking quickly.</p><h3 style="margin-top:20px;">Focus on Communication, Not Perfection</h3><p>Your main goal should be getting your message across clearly. If the other person understands you, you’ve succeeded! Perfection will naturally come with time and practice.</p><h3 style="margin-top:20px;">Start Small</h3><p>Engage in small talk with friends or colleagues, or even practice talking to yourself gracefully. Take advantage of AI speaking features to practice in a completely stress-free environment.</p>',
            ar: '<p>من الطبيعي تماماً الشعور بالقلق عند التحدث بلغة جديدة. إليك استراتيجيات نفسية عملية لمساعدتك على اكتساب الثقة:</p><h3 style="margin-top:20px;">تقبل ارتكاب الأخطاء</h3><p>الأخطاء دليل على أنك تحاول. كل خطأ هو فرصة للتعلم. حتى المتحدثون الأصليون يرتكبون أخطاء نحوية عندما يتحدثون بسرعة.</p><h3 style="margin-top:20px;">ركز على التواصل وليس الكمال</h3><p>يجب أن يكون هدفك الرئيسي هو إيصال رسالتك بوضوح. إذا استطاع الشخص الآخر فهمك، فقد نجحت! الكمال سيأتي بشكل طبيعي مع مرور الوقت والممارسة.</p><h3 style="margin-top:20px;">ابدأ بخطوات صغيرة</h3><p>انخرط في محادثات بسيطة مع الأصدقاء أو الزملاء، أو حتى تدرب على التحدث مع نفسك بسلاسة. استفد من ميزات التحدث المعتمدة على الذكاء الاصطناعي للتدرب في بيئة خالية تماماً من الضغوط.</p>'
        }
    },
    9: {
        title: { en: 'Mastering English Tenses Once and For All', ar: 'إتقان الأزمنة في اللغة الإنجليزية مرة واحدة وإلى الأبد' },
        content: {
            en: '<p>The English tense system can seem overwhelming, but breaking it down reveals a logical structure.</p><h3 style="margin-top:20px;">The Simple Tenses</h3><p>Use these for facts, habits, and general truths. E.g., "I work" (general habit), "I worked" (finished past action).</p><h3 style="margin-top:20px;">The Continuous (Progressive) Tenses</h3><p>Use these to emphasize that an action is currently in progress. E.g., "I am working" (right now).</p><h3 style="margin-top:20px;">The Perfect Tenses</h3><p>These bridge two different points in time. The Present Perfect ("I have worked") connects the past to the present importance. Practice distinguishing when an event finishes versus when its result matters to your current conversation.</p>',
            ar: '<p>قد يبدو نظام الأزمنة في اللغة الإنجليزية مربكاً، ولكن تقسيمه يكشف عن هيكل منطقي.</p><h3 style="margin-top:20px;">الأزمنة البسيطة (Simple Tenses)</h3><p>استخدمها للحقائق والعادات والحقائق العامة. مثال: "I work" (عادة عامة)، "I worked" (فعل منتهٍ في الماضي).</p><h3 style="margin-top:20px;">الأزمنة المستمرة (Continuous Tenses)</h3><p>استخدمها للتأكيد على أن فعلاً ما قيد التقدم حالياً. مثال: "I am working" (الآن).</p><h3 style="margin-top:20px;">الأزمنة التامة (Perfect Tenses)</h3><p>تقوم هذه الأزمنة بالربط بين نقطتين مختلفتين في الوقت. المضارع التام ("I have worked") يربط الماضي بأهميته في الحاضر. تدرب على التمييز بين موعد انتهاء الحدث وبين متى تكون نتيجته مهمة لمحادثتك الحالية.</p>'
        }
    },
    10: {
        title: { en: 'Is Daily Practice Better Than Weekly Study?', ar: 'هل الممارسة اليومية أفضل من الدراسة الأسبوعية؟' },
        content: {
            en: '<p>When learning a language, learners often wonder whether spending 3 hours on Sunday is better than spending 20 minutes every single day. The answer heavily leans towards daily practice.</p><h3 style="margin-top:20px;">Spaced Repetition</h3><p>Your brain consolidates memory during sleep. Doing short bursts of daily learning allows for repeated sleep cycles to lock in new vocabulary and grammar concepts.</p><h3 style="margin-top:20px;">Consistency Beats Intensity</h3><p>A daily habit turns English from a "chore" into part of your lifestyle. Over time, you build momentum, making studying feel completely effortless. LingoWise tracking tools are built precisely to help you build and monitor these vital daily habits.</p>',
            ar: '<p>عند تعلم لغة ما، غالباً ما يتساءل المتعلمون عما إذا كان قضاء 3 ساعات يوم الأحد أفضل من قضاء 20 دقيقة كل يوم. الإجابة تميل بشدة نحو الممارسة اليومية.</p><h3 style="margin-top:20px;">التكرار المتباعد (Spaced Repetition)</h3><p>يقوم عقلك بترسيخ الذاكرة أثناء النوم. إجراء جلسات قصيرة من التعلم اليومي يسمح لدورات النوم المتكررة بتثبيت المفردات والمفاهيم النحوية الجديدة.</p><h3 style="margin-top:20px;">الاستمرارية تتفوق على الكثافة</h3><p>العادة اليومية تحول اللغة الإنجليزية من "مهمة شاقة" إلى جزء من أسلوب حياتك. بمرور الوقت، تكتسب زخماً، مما يجعل الدراسة تبدو سهلة تماماً. تم تصميم أدوات التتبع في منصة LingoWise خصيصاً لمساعدتك على بناء ومراقبة هذه العادات اليومية الحيوية.</p>'
        }
    }
};
